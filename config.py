...
# Sudo users IDs, They are admins everywhere. Use space to separate.
...
UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "fantaestheticgang")
...
UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/brut69/CallMusicPlus69")
U_BRANCH = "master"
